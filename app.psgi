...
builder {
    ...
    enable 'CrossOrigin', origins => ['http://localhost:4242','http://m.tranzmt.it','http://api.tranzmt.it', 'https://vip.safewrd.app'], headers => '*', credentials => 1, expose_headers => '*', methods => '*';
    enable "Deflater";
