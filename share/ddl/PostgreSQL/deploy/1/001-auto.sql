...
-- Created on Thu May 26 17:27:43 2016
-- 
;
--
...
CREATE TABLE "pair" (
  ...
  "parent_device_id" character varying(36) NOT NULL,
  "child_device_id" character varying(36) NOT NULL,
  "parent_user_id" character(36) NOT NULL,
  "child_user_id" character(36) NOT NULL,
  "kliq_id" character(36) NOT NULL,
